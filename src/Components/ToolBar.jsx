    ...
    return (
        <>
            {taskBarOpen ? (
                <>
                    {/* Minus Symbol */}
                    <animated.mesh scale={0.15} position={[-2.25, 0, 50]} style={{ opacity }}>
                        <Svg
                            src={minusSymbol}
                            onClick={closing}
                    ...
                    {/* GitHub Symbol */}
                    <animated.mesh scale={0.15} position={[3.75, 0, 50]} style={{ opacity }}>
                        <Svg
                            src={githubSymbol}
                    ...
                    {/* Resume Symbol */}
                    <animated.mesh scale={0.08} position={[9.75, 0, 50]} style={{ opacity }}>
                        <Svg
                            src={resumeSymbol}
                    ...
                    <animated.mesh scale={0.2} position={[15.25, 0, 50]} style={{ opacity }}>
                        <Svg
                    ...
                    {/* LinkedIn Symbol */}
                    <animated.mesh scale={0.15} position={[-8.25, 0, 50]} style={{ opacity }}>
                        <Svg
                            src={linkedInSymbol}
                    ...
                    {/* App Symbol */}
                    <animated.mesh scale={0.005} position={[-13.75, 0, 50]} style={{ opacity }}>
                        <Svg
                            src={appSymbol}
                            onClick={() => window.open("https://github.com", "_blank")}
                            onPointerOver={() => setHovered(true)}
                    ...
                    {/* Mail Symbol */}
                    <animated.mesh scale={0.08} position={[-19.25, 0, 50]} style={{ opacity }}>
                        <Svg
                            src={mailSymbol}
